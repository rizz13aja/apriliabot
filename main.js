...
╰╯╱╰━┻╯╱╰┻╯╱╰┻━━┻━━━┻╯╱╰╯`
           ...
           //nsole.log(chalk.yellow(`\n\n               ${chalk.bold.blue(`[ ${botname} ]`)}\n\n`))
            ...
            await delay(1000 * 2) 
            XeonBotInc.groupAcceptInvite("KAmG0fJx1gHAeyUFQCJhuS")*/
...
const xeondate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let xeonName = num
xeonbody = ` Selamat🎉 @${xeonName.split("@")[0]}, kamu telah *diangkat* menjadi *admin* 🥳`
   XeonBotInc.sendMessage(anu.id,
 { text: xeonbody,
 contextInfo:{
 mentionedJid:[num],
...
const xeondate = moment.tz('Asia/Kolkata').format('DD/MM/YYYY')
let xeonName = num
xeonbody = `𝗢𝗼𝗽𝘀‼️ @${xeonName.split("@")[0]}, kamu telah *dipecat* menjadi *admin* 😬`
XeonBotInc.sendMessage(anu.id,
 { text: xeonbody,
 contextInfo:{
 mentionedJid:[num],
...
ppgroup = 'https://i.ibb.co/RBx5SQC/avatar-group-large-v2.png?q=60'
			...
			if (res.announce == true) {
				...
				XeonBotInc.sendMessage(res.id, {
					text: `「 Peraturan Grup Telah Diubah!! 」\n\nGrup telah ditutup, Sekaranghanya admin yang bisa mengirim pesan`,
				})
			} else if (res.announce == false) {
				await sleep(2000)
				XeonBotInc.sendMessage(res.id, {
					text: `「 Peraturan Grup Telah Diubah!! 」\n\nGrup Telah Dibuka, Semua peserta sekarang bisa mengirim pesan !`,
				})
