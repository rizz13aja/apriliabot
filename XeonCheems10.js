...
if(time2 < "23:59:00"){
var xeonytimewisher = `Selamat Malam Beb :) 🌌`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `Selamat Sore Menjelang Malam Beb :) 🌃`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `Selamat Sore Menjelang Malam Beb :) 🌃`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `Selamat Sore Beb :) 🌅`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Selamat Siang Beb :) 🌄`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Selamat Pagi beb :) 🌄`
 } 
//function
...
module.exports = XeonBotInc = async (XeonBotInc, m, chatUpdate, store) => {
    ...
    replygcxeon(`Maaf Beb, Fitur Ini Khusus Pengguna Premium. Silahkan Tag / Chat Owner Aku Agar Bisa Menambahkanmu Jadi Anggota Premium :* `)
}
        //script replier
...
"《 ██████████▒▒》80%",
"《 ████████████》100%",
"Aku Mulai Recode Bugnya Yaa 🐦..."
]
let { key } = await XeonBotInc.sendMessage(from, {text: 'Tunggu Sebentar yangg...'})
...
async function styletext(teks) {
    ...
    resolve(xeonyresult)
        ...
        async function useLimit(senuseLimitder, amount) {
            ...
            replygcxeon(`Kamu Sudah Memakai: ${amount} limit\nRemaining: ${db.data.users[sender].limit} limit`)
        }
        ...
        if (!m.isGroup && !XeonTheCreator && db.data.settings[botNumber].onlygrub ) {
        	if (isCommand){
            return replygcxeon(`Hallo Sayangg, Kita Lanjut Digrup Aja Yah :) !\n\nJika Aku Salah, Harap Hubungi Pemilik Aku wa.me/${ownernumber}`)
            }
        }
        // Private Only
        if (!XeonTheCreator && db.data.settings[botNumber].onlypc && m.isGroup) {
        	if (isCommand){
	         return replygcxeon("Hallo sayangg, Buat Ini Kita Lanjut Pc Aja Yahh :)")
	     }
	}
	...
	if (db.data.settings[botNumber].autobio) {
            XeonBotInc.updateProfileStatus(`${botname} Aku telah Menemanimu Selama ${runtime(process.uptime())}`).catch(_ => _)
        }
     //auto type record
...
if (isGroupAdmins) return replygcxeon('*Aku Mendeteksi Virtex !!!*')
...
XeonBotInc.sendMessage(`${ownernumber}@s.whatsapp.net`,{text: `Hallo Sayang! wa.me/${sender.split("@")[0]} Udah Ngirim Virtex  ${isGroup?`Di ${groupName}`:''}`})
 }
 }
 ...
 if (db.data.chats[m.chat].antibot) {
    if (m.isBaileys && m.fromMe == false){
        if (isAdmin || !isBotAdmin){		  
          ...
          replygcxeon(`*Bot Lain Dideteksi!!!*\n\nCuma Aku Yang Boleh Ada Disini!!!`)
    return await XeonBotInc.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
        ...
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Kamu Telah Mengirim File !!! 」\`\`\`\n\nMaaf Beb, Disini Gak Boleh Kirim File Yahh :)`)
    ...
    if(isXeonMedia === "imageMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Kamu Telah Mengirim Foto Tanpa Fitur !!! 」\`\`\`\n\nMaaf Beb, Ngirim Foto Disini Wajib Pakai Fitur Sekali Lihat :)`)
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        }
    }
  }
    ...
    if(isXeonMedia === "videoMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Kamu Telah Mengirim Video Tanpa Fitur !!! 」\`\`\`\n\nMaaf Beb, Ngirim Video Disini Wajib Pakai Fitur Sekali Lihat :)`)
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        }
    }
  }
    ...
    if(isXeonMedia === "stickerMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Kamu Telah Mengirim Stiker !!! 」\`\`\`\n\nTolong Jangan Kirim Stiker yah, Kamu Bisa Mengekspresikan Perasaan Kamu Lewat Emote Kok :)`)
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        }
    }
  }
    ...
    if(isXeonMedia === "audioMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Kamu Telah Mengirim Audio Tanpa Fitur !!! 」\`\`\`\n\nMaaf Beb, Ngirim Audio Disini Wajib Pakai Fitur Sekali Lihat :)`)
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        }
    }
  }
    ...
    if(isXeonMedia === "locationMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Kamu Gaboleh ngirim Sharelok Disini !!! 」\`\`\`\n\nAku Gamau Yah Kalo Sampe Ada Orang Lain yang Tau Keberadaan Kamu !!!`)
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        }
    }
  }
    ...
    if(isXeonMedia === "documentMessage"){
        if (XeonTheCreator || isAdmins || !isBotAdmins){		  
          ...
          replygcxeon(`\`\`\`「 Jangan Ngirim Dokumen Disini !!! 」\`\`\`\n\nKamu Bisa Kirim Dokumen Itu Di Pc beb :)`)
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        }
    }
  }
    ...
    return XeonBotInc.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: false, id: m.key.id, participant: m.key.participant }})
        ...
        if (db.data.chats[m.chat].badword) {
			...
			XeonBotInc.sendMessage(from, {text:`\`\`\`「 Ihh Jangan Ngomong Kasarr !!! 」\`\`\`\n\n@${m.sender.split("@")[0]} Sekali Lagi Ngomong Kasar Aku Jewer Yah Kamu !!!`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
               }
            }
        }
        //autosticker
        ...
        if (db.data.chats[m.chat].antilinkgc) {
            if (budy.match(`chat.whatsapp.com`)) {
               bvl = `\`\`\`「 Jangan Ngirim Link Gc Lain Disini yah !!! 」\`\`\`\n\nEhh Ternyata Admin, Maap Ya minn Cuma Bercanda hehe😇`
...
if (XeonTheCreator) return replygcxeon(bvl)
			...
			XeonBotInc.sendMessage(from, {text:`\`\`\`「 Jangan Ngirim Link Gc Lain Disini yah !!! 」\`\`\`\n\n@${m.sender.split("@")[0]} Jangan Ngemis Member Disini !!!`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
            }
        }
        if (db.data.chats[m.chat].antilink) {
            if (budy.match('http') && budy.match('https')) {
               bvl = `\`\`\`「 Kamu Gak Boleh Ngirim Link Disini !!! 」\`\`\`\n\nEhh Ternyata Admin, Maap Ya minn Cuma Bercanda hehe😇`
if (isAdmins) return replygcxeon(bvl)
if (m.key.fromMe) return replygcxeon(bvl)
if (XeonTheCreator) return replygcxeon(bvl)
               await XeonBotInc.sendMessage(m.chat,
			...
			XeonBotInc.sendMessage(from, {text:`\`\`\`「 Kamu Gak Boleh Ngirim Link Disini !!! 」\`\`\`\n\n@${m.sender.split("@")[0]} Sekali Lagi Ngeyel Awas Yah Kamu Huhh !!!`, contextInfo:{mentionedJid:[m.sender]}}, {quoted:m})
            }
        }
        //afk
        let mentionUser = [...new Set([...(m.mentionedJid || []), ...(m.quoted ? [m.quoted.sender] : [])])]
	     for (let jid of mentionUser) {
            ...
            replygcxeon(`Jangan Ganggu Bebeb Akuuuuuuuuuu !!!\nDia Lagi Sibuk !!! ${reason ? 'Katanya Mau ' + reason : 'Apaa yah, Gatauu Pokoknya Jangan Ganggu Dia !!!'}\nDia Sibuk Dari ${clockString(new Date - afkTime)}`.trim())
        }
        if (db.data.users[m.sender].afkTime > -1) {
            let user = global.db.data.users[m.sender]
            replygcxeon(`Ehh Bebeb Aku Udah Gak Sibuk Ya :)\nEmang Udh Selesai ${user.afkReason ? user.afkReason : ''} Nya?\nAku Nungguin Kamu Loh Selama ${clockString(new Date - user.afkTime)}`.trim())
            user.afkTime = -1
            user.afkReason = ''
        }
	...
	if (m.key.fromMe) return
        ...
        if (room) {
            ...
            if (!isSurrender && 1 > (ok = room.game.turn(m.sender === room.game.playerO, parseInt(m.text) - 1))) {
                replygcxeon({
                    '-3': 'Yahh Kamu Payahh Ihhh',
                    '-2': 'Salah Sayanggg !!!',
                    '-1': 'Yahh Padahal Dikit Lagi :(',
                    0: 'Hmmm :(',
                } [ok])
                return !0
            }
...
${isWin ? `@${winner.split('@')[0]} Kamu Menang Beb :*` : isTie ? `Seri, Kalian Berdua Hebat Kok :)` : `Turn ${['❌', '⭕'][1 * room.game._currentTurn]} (@${room.game.currentTurn.split('@')[0]})`}
❌: @${room.game.playerX.split('@')[0]}
⭕: @${room.game.playerO.split('@')[0]}

Ketik *surrender* Kalo Kamu Ngaku Kalah Yah`
	    ...
	    XeonBotInc.sendTextWithMentions(m.chat, `@${roof.p2.split`@`[0]} Yahh Dia Gamau, Gajadi Suitnya Dong :(`, m)
	    ...
	    XeonBotInc.sendText(m.chat, `Suitnya Udh Aku Kirim Ya Ke

@${roof.p.split`@`[0]} dan 
@${roof.p2.split`@`[0]}

Ayo Pilih Gunting, Batu Atau Kertas"
Pilih Di Chat Aku ya https://wa.me/${botNumber.split`@`[0]}`, m, { mentions: [roof.p, roof.p2] })
	    if (!roof.pilih) XeonBotInc.sendText(roof.p, `Ayoo Pilih \nBatu🗿\nKertas📄\nGunting✂️`, m)
	    if (!roof.pilih2) XeonBotInc.sendText(roof.p2, `Ayoo Pilih \nBatu🗿\nKertas📄\nGunting✂️`, m)
	    roof.waktu_milih = setTimeout(() => {
	    if (!roof.pilih && !roof.pilih2) XeonBotInc.sendText(m.chat, `Kalian Berdua Gajadi Main?\nHmm Yaudah Deh :(`)
	    else if (!roof.pilih || !roof.pilih2) {
	    win = !roof.pilih ? roof.p2 : roof.p
	    XeonBotInc.sendTextWithMentions(m.chat, `@${(roof.pilih ? roof.p2 : roof.p).split`@`[0]} Gak Milih, Dia Di anggep Kalah`, m)
	    }
	    delete this.suit[roof.id]
	    return !0
	    }, roof.timeout)
	    ...
	    roof.text = m.text
	    replygcxeon(`Kamu Udh Milih ${m.text} ${!roof.pilih2 ? `\n\nSabar Ya Beb, Sebelah Lagi Milih` : ''}`)
	    if (!roof.pilih2) XeonBotInc.sendText(roof.p2, '_Beb, Sebelah Udh Milih Nih\nTinggal Kamu Yang Belum', 0)
	    }
	    if (jwb2 && reg.test(m.text) && !roof.pilih2 && !m.isGroup) {
	    roof.pilih2 = reg.exec(m.text.toLowerCase())[0]
	    roof.text2 = m.text
	    replygcxeon(`Kamu Udah Milih ${m.text} ${!roof.pilih ? `\n\nSabar Ya Beb, Sebelah Lagi Milih` : ''}`)
	    if (!roof.pilih) XeonBotInc.sendText(roof.p, '_Beb, Sebelah Udh Milih Nih\nTinggal Kamu Yang Belum', 0)
	    }
	    ...
	    XeonBotInc.sendText(roof.asal, `_*Hasilnyaaa*_${tie ? '\nSERI Gaess Ternyata...' : ''}
...
fs.writeFileSync('./src/data/role/user.json', JSON.stringify(xeonverifieduser, null, 2))
        ...
        switch (isCommand) {
            case 'addbadword': case 'addbd':
               ...
               if (args.length < 1) return replygcxeon( `Send command ${prefix}addbadword [harsh word]. Contoh ${prefix}addbadword asshole`)
               bad.push(q)
            ...
            case 'delbadword': case 'deldb':
               if (!XeonTheCreator) return XeonStickOwner()
               if (!groupAdmins) return replygcxeon(mess.admin)
               if (args.length < 1) return replygcxeon( `Send commands ${prefix}addbadword [bad word]. Contoh ${prefix}addbadword asshole`)                 
               bad.splice(q)
               fs.writeFileSync('./src/data/function/badword.json', JSON.stringify(bad))
            ...
            case 'setmenu':{
               if (!XeonTheCreator) return XeonStickOwner()
               if (!text) return replygcxeon(`Aku Punya 8 Penampilan(v1,v2,v3,v4,v5,v6,v7,v8)\nMenurut Kamu Cocok Yang Mana?\nContoh ${prefix + command} v1`)
               if (text.startsWith('v')) {
                  typemenu = text
                  replygcxeon(mess.done)
               } else {
                  replygcxeon(`Aku Punya 8 Penampilan(v1,v2,v3,v4,v5,v6,v7,v8)\nMenurut Kamu Cocok Yang Mana\nContoh ${prefix + command} v1`)
               }
            }
            break
            case 'setreply':{
...
m.reply(`*Temporary Sukses*\nAku Lagi Spam Otp Ke dia\nKetik ${prefix}stoptempor Kalo Kamu Udah Puas Yah`);
...
break
            ...
            case 'restart': case 'restartbot': case 'stoptempor':{
                m.reply(`Aku ${command} Dulu, Sabar Yah sayang....`)
                await sleep(2300)
                process.exit(1);
                m.reply(`Aku Berhasil ${command}`)
            }
        case 'jadibot': {
            if (!text) return replygcxeon('*<!> Contoh:* .jadibot 628xxx')
if (!XeonTheCreator) return replygcxeon('Maaf Beb, Ini Khusus Pemilik Aku')
if (m.isGroup) return replygcxeon("Maaf beb, Jangan disini. Kita lanjut di Chat Pribadi Aja yah :)")      
...
break            
            ...
            case 'addprem':
                ...
                if (m.mentionedJid.length !== 0) {
                    ...
                    replygcxeon("Dia Sekarang Premium :)")
                } else {
            ...
            case 'ipbot':
                ...
                http.get({
                    ...
                    resp.on('data', function(ip) {
                        replygcxeon("🔎 Ip Aku: " + ip);
                    })
                })
            break
            case 'request': case 'reportbug': {
	if (!text) return replygcxeon(`Contoh : ${
        prefix + command
...
if (!isAdmins && !XeonTheCreator) return XeonStickAdmin()
            ...
            case 'self': {
                ...
                replygcxeon('*Berhasil, Sekarang Aku Hanya Setia Kepada Ownerku :)*')
            }
            break
            case 'public': {
                if (!XeonTheCreator) return XeonStickOwner()
                XeonBotInc.public = true
                replygcxeon('*Berhasil, Sekarang Kalian Adalah Sahabatku :)*')
            }
            break
            case 'mode':
                if (!XeonTheCreator) return XeonStickOwner()
                if (args.length < 1) return replygcxeon(`Contoh ${prefix + command} public/self`)
                if (q == 'public') {
                    XeonBotInc.public = true
                    replygcxeon(mess.done)
                } else if (q == 'self') {
...
if (!isAdmins && !XeonTheCreator) return XeonStickAdmin()
               ...
               if (args[0] === 'on') {
                  ...
                  replygcxeon(`${command} Sudah Aktif Beb :)`)
               } else if (args[0] === 'off') {
                  db.data.chats[from].badword = false
                  replygcxeon(`${commad} Nonaktif`)
               }
               }
            break
            case 'react': {
...
if (!isAdmins && !XeonTheCreator) return XeonStickAdmin()
if (args[0] === "on") {
if (AntiNsfw) return replygcxeon('Sudah Aktif Beb :)')
ntnsfw.push(from)
fs.writeFileSync('./src/data/function/nsfw.json', JSON.stringify(ntnsfw))
replygcxeon('Sudah Aktif Beb, Awas Kalo Sagapung !!!')
...
XeonBotInc.sendMessage(from, {text: `\`\`\`「 ⚠️Warning⚠️ 」\`\`\`\n\nNsfw(Fitur Pemersatu Bangsa) Fitur ini dinonaktifkan untuk grup, Takut Sagapung Masal Wkwk`, contextInfo: { mentionedJid : mems }}, {quoted:m})
} else if (args[0] === "off") {
	...
	if (!XeonTheCreator) return XeonStickOwner()
            ...
            if (text.split("|") < 2)
                return await replygcxeon(
                    `Bikin Dengan Format Gini Nih\nContoh: ${prefix}Siapa Disini Yang Paling Ganteng?|Rizz,Rizieq,Rizz13...`
                )
            let options = []
...
break
        ...
        case 'vote': {
            ...
            if (!text) return replygcxeon(`Enter Reason for Vote, Contoh: *${prefix + command} Handsome Owner*`)
...
break
            ...
            case 'rentbot':
                ...
                break
                case 'tqto':
         replygcxeon(`Thanks to:\nRizz(Pembuat Script)\nNara(Visual Creator)\nSemua Admin dan Member KKR`)
                break
                case'menulist':
...
if (!isGroup) return replygcxeon('Hanya Di Group')
    ...
    replygcxeon('Absen telah dimulai! Ketik *.absen* untuk Absen.');
}
break;
...
if (!isGroup) return replygcxeon('Hanya Di Group')
    ...
    replygcxeon('Kamu Berhasil Absen, Jangan Langsung Ilang ya, Minimalnya Nim Sebentar :)');
}
break;
...
break
            ...
            case 'emojimix': {
                ...
                if (!emoji1) return replygcxeon(`Contoh : ${prefix + command} 😅+🤔`)
            ...
            break
            case 'emojimix2': {
                if (!text) return replygcxeon(`Contoh : ${prefix + command} 😅`)
            ...
            break
            case 'fliptext': {
                if (args.length < 1) return replygcxeon(`Contoh:\n${prefix}fliptext dgxeon`)
                quere = args.join(" ")
  ...
  break
  case 'volaudio': {
if (!args.join(" ")) return replygcxeon(`Contoh: ${prefix + command} 10`)
...
teks += `│\n└────────────⭓\n\n*Total Kata Yang Dilarang : ${bad.length}*`
replygcxeon(teks)
}
break
            ...
            case 'tictactoe': {
                ...
                if (room) {
                    replygcxeon('Mau Lawan Siapa beb?')
                    room.o = m.chat
                    room.game.playerO = m.sender
                    room.state = 'Lagi Bermain'
                    let arr = room.game.render().map(v => {
                        return {
                            X: '❌',
                            O: '⭕',
...
Ketik *surrender* Menyerah dan Ngaku Kalah`
                    ...
                    replygcxeon('Menunggu Lawan' + (text ? ` type the command below ${prefix}${command} ${text}` : ''))
...
@${m.sender.split`@`[0]} Menantang @${m.mentionedJid[0].split`@`[0]} Buat Suit

Silahkan @${m.mentionedJid[0].split`@`[0]} Ketik accept/reject`
                this.suit[id] = {
                    ...
                    p: m.sender,
                    p2: m.mentionedJid[0],
                    status: 'Tunggu Ya Beb...',
                    waktu: setTimeout(() => {
                        if (this.suit[id]) XeonBotInc.sendText(m.chat, `_Suit Berakhir_`, m)
                        delete this.suit[id]
                    }, 60000),
                    poin,
                    poin_lose,
            ...
            case 'mathquiz': case 'math': {
                if (kuismath.hasOwnProperty(m.sender.split('@')[0])) replygcxeon(`Kamu Belum Menyelesaikan Pertanyaan Sebelumnya sayang...`)
                let { genMath, modes } = require('./lib/math')
                if (!text) return replygcxeon(`Mode: ${Object.keys(modes).join(' | ')}\nUsage Contoh: ${prefix}math medium`)
            ...
            case 'afk': {
                ...
                user.afkReason = text
                replygcxeon(`${m.pushName} *Sedang Sibuk, Katanya*${text ? ': ' + text : ''}`)
            }
            break	
            case 'ai': 
            case 'ask':
            case 'openai': {
               if (db.data.users[sender].limit < 1) return replygcxeon(mess.limit)
	            if (!q) return replygcxeon(`Contoh : ${prefix + command} who is ronaldo`)
			   ...
			   break
    case 'xxqc': {
if (!q) return replygcxeon(`📌Contoh: ${prefix + command} pink hallo\n\n꒰ 🖌️ Color List ꒱ ೄྀ࿐ ˊˎ-\n━━━━━━⊱⋆⊰━━━━━━\npink\nblue\nred\ngreen\nyellow\npurple\ndarkblue\nlightblue\nash\norange\nblack\nwhite\nteal\nlightpink\nchocolate\nsalmon\nmagenta\ntan\nwheat\ndeeppink\nfire\nskyblue\nsafron\nbrightskyblue\nhotpink\nlightskyblue\nseagreen\ndarkred\norangered\ncyan\nviolet\nmossgreen\ndarkgreen\nnavyblue\ndarkorange\ndarkpurple\nfuchsia\ndarkmagenta\ndarkgray\npeachpuff\nblackishgreen\ndarkishred\ngoldenrod\ndarkishgray\ndarkishpurple\ngold\nsilver`)
...
case 'addmsg': {
	if (!XeonTheCreator) return XeonStickOwner()
                ...
                if (!text) return replygcxeon(`Contoh : ${prefix + command} filename`)
...
View list of Messages With ${prefix}listmsg`)
            ...
            break
            case 'getmsg': {
                if (!text) return replygcxeon(`Contoh : ${prefix + command} file name\n\nView list of messages with ${prefix}listmsg`)
                let msgs = global.db.data.database
...
if (!q) return replygcxeon(`Contoh ${prefix+command} const xeonbot = require('baileys')`)
...
case 'yts': case 'ytsearch': {
                if (!text) return replygcxeon(`Contoh : ${prefix + command} story wa anime`)
...
break
case 'google': {
if (!q) return replygcxeon(`Contoh : ${prefix + command} ${botname}`)
await XeonStickWait()
...
if (!q) return replygcxeon(`Contoh ${prefix+command} DGXeon`)
await XeonStickWait()
...
break
case 'npmstalk':{
if (!q) return replygcxeon(`Contoh ${prefix+command} xeonapi`)
await XeonStickWait()
...
case '1':{
replygcxeon('[ *Coming soon* ] `Fitur ini belum ada karena ini fitur Belum tersedia Untuk saat ini Tunggu rilis Version Selanjutnya Versi Full realise Belum di tentukan`')
}
break
case '2':{
replygcxeon('[ *Coming soon* ] `Fitur ini belum ada karena ini fitur Belum tersedia Untuk saat ini Tunggu rilis Version Selanjutnya Versi Full realise Belum di tentukan`')
...
break
case 'happymod':{
if (!q) return replygcxeon(`Contoh ${prefix+command} Sufway surfer mod`)
await XeonStickWait()
...
break
case 'ringtone': {
		if (!text) return replygcxeon(`Contoh : ${prefix + command} black rover`)
...
case 'how': {
            ...
            break
case 'rate': {
            	if (!text) return replygcxeon(`Contoh : ${prefix + command} my profile`)
...
break
case 'handsomecheck':
				if (!text) return replygcxeon(`Tag Someone, Contoh : ${prefix + command} @Rizz13`)
...
case 'telestick': {
	...
	} else replygcxeon(`Where is the telegram sticker link?\nContoh. ${prefix + command} https://t.me/addstickers/FriendlyDeath`)
}
break
case 'shadow': 
case 'write': 
...
case 'quotesunder':
case 'shinetext':{
if (!q) return replygcxeon(`Contoh : ${prefix+command} XeonBotInc`) 
await XeonStickWait()
...
try {
  ...
  try {
    ...
    if (!chapterInput) {
      throw new Error(`Please specify the chapter number or name. Contoh: ${prefix + command} john 3:16`)
    }
...
break
  case 'totalfeature':
        ...
        break
            ...
            let me = m.sender
            let xmenu_oh = `
*ʜᴀʟʟᴏ Beb👋.* ɴᴀᴍᴀku  *Aprilia* ʙᴏᴛ ᴍᴅ
...
replygcxeon(`*Aku Udh Kirim Virtex sebanyak ${amount} Tunggu 3 Menit Ya sayang, Baru di lanjut*`)
break
case 'pmbug' :{
 if (!isPremium) return replygcxeon(mess.premium)
 if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nContoh ${prefix+command} 916909137213`)
...
replygcxeon(`*Aku Udh Kirim Virtex ke ${victim} Tunggu 3 Menit Ya sayang, Baru di lanjut*`)
break
case 'delaybug' : {
if (!isPremium) return replygcxeon(mess.premium)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nContoh ${prefix+command} 916909137213`)
...
case 'gcbug' : {
if (!isPremium) return replygcxeon(mess.premium)
 if (!args[0]) return replygcxeon(`Use ${prefix+command} link\nContoh ${prefix+command} https://chat.whatsapp.com/JVKKTg3rmmiKEL3MQBVplg`)
await loading()
let result = args[0].split('https://chat.whatsapp.com/')[1]
...
replygcxeon(`*Aku Udh Kirim Virtex ke ${xeongc} Tunggu 3 Menit Ya sayang, Baru di lanjut*`)
}
break
case 'delaygcbug' :  {
if (!isPremium) return replygcxeon(mess.premium)
...
case 'out': case 'verif':{
if (!isPremium) return replyprem(mess.premium)
if (!args[0]) return replygcxeon(`Use ${prefix+command} number\nContoh ${prefix+command} 916969696969`)
